// netlify/functions/kawal_spip_handler.js
...
exports.handler = async (event) => {
  ...
  // HANYA BACA DARI QUERY STRING – TIDAK MENYENTUH event.body
  ...
  try {
    switch (action) {
      ...
      default: return res({ status: 'error', message: 'Aksi tidak dikenal' });
    }
  } catch (err) {
